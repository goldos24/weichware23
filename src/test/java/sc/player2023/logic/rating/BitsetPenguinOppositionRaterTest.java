 ...
 * @since 18.01.2023
 */
public class BitsetPenguinOppositionRaterTest {

    private final BitsetPenguinOppositionRater rater = new BitsetPenguinOppositionRater();
    ...
    void rateInComplexCase() {
        ...
        assertEquals(new Rating(22), rater.rate(gameState), "PenguinOpposition (bitset)");
    }
    ...
    void OppositionRaterWorksLikeReachable() {
        ...
        assertEquals(expected, rater.rate(gameState), "OppositionReachableRater (bitset)");
    }
